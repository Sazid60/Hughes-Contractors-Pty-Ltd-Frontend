...
const Certificates = ({ certifications }: CertificatesSectionProps) => {
        ...
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-6">
          {certifications.map((cert: any) => (
            <div
              ...
              className="flex flex-col items-center text-center"
            >
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-30 md:h-30  overflow-hidden flex items-center justify-center bg-white">
                <img
                  src={cert.imageUrl || "/placeholder.png"}
                  alt={cert.title}
                  className="w-full h-full object-cover"
